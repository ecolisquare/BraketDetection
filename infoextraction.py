    ...
    for i,segment in enumerate(poly_refs):
        ...
        if s1 is not None and s2 is not None and s3 is not None:
            ...
            if count>2:
                ...
                is_inside=False
            if distance < segmentation_config.parallel_max_distance and is_inside==False and not isinstance(segment.ref,DArc) and l1>segmentation_config.contraint_edge_min_length: 
                #contraint
                # print(1)
                others.add(other)
                segment.isPart=True
                ...
                segment.isConstraint = True
                poly_refs[i].isConstraint = True
            elif l1<l2 *segmentation_config.contraint_factor and is_inside==False and not isinstance(segment.ref,DArc) and l1>segmentation_config.contraint_edge_min_length:
                #constraint
                # print(2)
                others.add(other)
                segment.isPart=True
                ...
                segment.isConstraint = True
                poly_refs[i].isConstraint = True
            elif l1<segmentation_config.free_edge_min_length and is_inside==False and not isinstance(segment.ref,DArc) and l1>segmentation_config.contraint_edge_min_length:
                # print(3)
                others.add(other)
                segment.isPart=True
                poly_refs[i].isPart=True
